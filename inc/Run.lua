...
boss = Token:match("(%d+)")
redis:set(boss..":VERSION",1.00)
redis:set(boss..":SUDO_ID:",SUDO_USER)
redis:set(boss..":DataCenter:",'German')
...
local NameGroup = Flter_Markdown(redis:get(boss..'group:name'..arg.chat_id_) or "")
...
redis:setex(boss..'sender:'..data.id_..':'..arg.chat_id_..'flood',300,true)
...
boss..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_,
boss..':photo:'..msg.chat_id_..':'..msg.sender_user_id_,
boss..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_,
boss..':voice:'..msg.chat_id_..':'..msg.sender_user_id_,
boss..':audio:'..msg.chat_id_..':'..msg.sender_user_id_,
boss..':animation:'..msg.chat_id_..':'..msg.sender_user_id_,
boss..':edited:'..msg.chat_id_..':'..msg.sender_user_id_,
boss..':video:'..msg.chat_id_..':'..msg.sender_user_id_,
boss..':Flood_Spam:'..msg.sender_user_id_..':'..msg.chat_id_..':msgs')
return false 
end
...
if Plug.boss then 
if msg.text and not msg.forward_info_ and Plug.iboss then
...
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,d) vardump(d)end,nil)   
	...
	download_file('https://raw.githubusercontent.com/UUIYY/boss/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/UUIYY/boss/master/plugins/games.lua','./plugins/games.lua')
